...
def render_tables(
    ...
    *,
    ...
    add(
        ...
        f"*Success requires correct target-language identification and ASR error < {threshold_percent:g}%. Confidence intervals remain clustered by reference and target text.*",
        "",
    ...
    add(
        ...
        f"*Success: correct target LID and ASR error < {threshold_percent:g}%.*",
        "",
